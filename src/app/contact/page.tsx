            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">hello@movastudio.com</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                <Link href="/services">
                  <Button
                    variant="outline"
                    className="w-full lg:w-auto font-bold text-blue-700 border-blue-500 hover:bg-blue-50 hover:text-blue-900 transition-colors"
                  >
                    View Our Services
                  </Button>
                </Link>
